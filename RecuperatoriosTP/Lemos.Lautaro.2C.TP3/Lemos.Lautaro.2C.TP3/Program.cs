...
namespace Lemos.Lautaro._2C.TP3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                Alumno a2 = new Alumno(2, "Juana", "Martinez", "12234458", EntidadesAbstractas.Persona.ENacionalidad.Extranjero, Universidad.EClases.Laboratorio, Alumno.EEstadoCuenta.Deudor); //lanza NacionalidadInvalidaException
                uni += a2;
            }
            ...
            try
            {
                Alumno a3 = new Alumno(3, "José", "Gutierrez", "12234456", EntidadesAbstractas.Persona.ENacionalidad.Argentino, Universidad.EClases.Programacion, Alumno.EEstadoCuenta.Becado); //lanza AlumnoRepetidoException
                uni += a3;
            }
